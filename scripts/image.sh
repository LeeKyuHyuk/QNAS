...
echo "tar -cvzf $IMAGES_DIR/QNAS-$CONFIG_QNAS_VERSION.tar.gz bin boot dev etc lib lib64 linuxrc media mnt opt proc root run sbin sys tmp usr var" >> $BUILD_DIR/_fakeroot.fs
