...
echo "/var/lib/nginx	d	755	33	33	-	-	-	-	-" >>$BUILD_DIR/_device_table.txt
echo "/srv/mysql	d	755	40	40	-	-	-	-	-" >>$BUILD_DIR/_device_table.txt
...
echo "tar -cvzf $IMAGES_DIR/QNAS-$CONFIG_QNAS_VERSION.tar.gz bin boot dev etc lib lib64 linuxrc media mnt opt proc root run sbin srv sys tmp usr var" >>$BUILD_DIR/_fakeroot.fs
